Все пункты ниже реализованы для набора данных о сердце (kaggle.com/datasets/pritsheta/heart-attack) с использованием языков программирования R и Python. Программный код необходимыми комментариями.
